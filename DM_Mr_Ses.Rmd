---
title: "Analyse du bilan d'un Groupe Pétrolier de 1969 à 1984"
...
**Conclusion :**
  ...
  * Le premier facteur est prépondérant, il conserve **55.87%** de l'inertie du nuage. Il est peu probable qu'il soit dÃ» au hasard. Il existe une structuration importante des données qui va se manifester sur le premier axe (1/2 au lieu de 1/8).
...
De plus, grÃ¢ce au premier axe, nous identifions une opposition de
...
notamment l'avant et l'aprés le choc.
...
Ce qui fait qu'il y'a naturellement trois périodes qui se dégagent:  
  ...
  * la période (1969-1973) précédent le premier choc pétrolier qui est marquée par une Situation nette(**NET**) et des Immobilisations(**IMM**).
